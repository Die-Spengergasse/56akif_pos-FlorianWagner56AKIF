...
namespace ValueTypes
{
    class TypeExercise
    {
        ...
        {
            return (nettopreis * steuerProdukt) ?? (nettopreis * steuerKategorie) ?? (nettopreis * 1.2M); //M steht für money --> decimal
        }
        ...
        {
            //Es kann eine Exception auftreten, wenn der Parameter "wert" null ist.
            return (int)wert/8;
        }
