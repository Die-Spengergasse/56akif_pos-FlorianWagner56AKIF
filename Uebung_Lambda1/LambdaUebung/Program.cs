...
class Program
{
    ...
    {
        //Kommentare sind die vorigen Versionen --> die jeweils darunter liegende Zeile stellt die Verbesserung dar!

        Console.WriteLine("Beispiel 1: Converter");
        //decimal[] converted = LambdaTest.Converter(new decimal[] { -10, 0, 10, 20, 30 }, CelsiusToKelvin);
        decimal[] converted = LambdaTest.Converter(new decimal[] { -10, 0, 10, 20, 30 }, cToKelvin => cToKelvin + 273.15M); 
        ...
        decimal[] freezed = LambdaTest.Filter(converted, freezes => freezes < 273.15M);
        ...
        decimal result = LambdaTest.ArithmeticOperation(2, 0, (x, y) => y is 0 ? 0 : x / y);
